//Refer Longest Palindromic Subsequence
...
public:
    int makePalindrome(string sa){
        return sa.size() - lps(sa); //Retain the longest palindromic subsequence & make insertions according to remaining.
    }
